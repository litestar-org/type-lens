...
from type_lens.__metadata__ import __project__ as project
from type_lens.__metadata__ import __version__ as version
...
# -- Project information -----------------------------------------------------
author = "Jolt Org"
release = os.getenv("_TYPE_LENS_DOCS_BUILD_VERSION", version.rsplit(".")[0])
...
html_theme_options = {
    ...
    "github_url": "https://github.com/jolt-org/type-lens",
    "nav_links": [
        {"title": "Home", "url": "https://type-lens.jolt.rs"},
        {"title": "Docs", "url": "https://docs.type-lens.jolt.rs"},
        {"title": "Code", "url": "https://github.com/jolt-org/type-lens"},
    ],
    "light_css_variables": {
        # RGB
